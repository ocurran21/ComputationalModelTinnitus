function spm_DEM_qU(qU,pU,hidden_state, external_input_sound)
...
for i = 1:g
    ...
    if N == 1
        ...
        try
            ...
            if hidden_state=='internal'
                plot(t,X{1,1}(1,:)),box off
                %plot(t,external_input_sound(1,:)), box off
            end
            if hidden_state=='external'
                plot(t,X{1,1}(2,:)),box off
            end
            set(gca,'XLim',[t(1) t(end)])
            a   = axis;
